...
const Page = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 mt-24 mb-10">
      <h1 className="font-extrabold text-4xl text-[#0A303A] text-center mb-8">
        Bizning ota-onalarimiz uchun
      </h1>
        ...
        <div className="flex gap-10 ml-64 max-md:flex-wrap-reverse max-md:ml-0  ">
          ...
          <form onSubmit={handleSubmit}>
            <div id="regis" className="flex flex-col flex-grow">
              <h3 className="font-bold text-xl md:text-2xl mb-10 text-[#0A2F38]">
                va ekskursiyani rejalashtiring
              </h3>
              ...
              <div className="flex flex-col gap-3 md:flex-row md:gap-3 mb-6">
                <input
                  type="text"
                  placeholder="Ism"
                  className="w-full p-2 outline-none border rounded-md focus:border-2 focus:font-medium"
                  name="firstName"
...
const Card = ({ icon, title, description, bgColor }) => {
  return (
    <div
      className={`w-full p-4 bg-white rounded-xl flex flex-col items-center ${
        bgColor ? `bg-${bgColor}` : ""
      }`}
    >
      <FontAwesomeIcon className="text-[#E72929] text-4xl mb-3" icon={icon} />
      <h4 className="font-bold text-xl text-[#0A303A] mb-3 text-center">
        {title}
      </h4>
